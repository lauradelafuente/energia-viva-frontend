        ...
        <Grid sm={6} alignItems="flex-start" className="barra">
          <Box paddingX={20}>
            ...
            <Typography
              ...
              style={{ color: "white" }}
            >
              Nossa equipe é composta por seis desenvolvedores formados na
              Generation Brasil. O e-commerce tem como base uma das ODS's
              (Objetivos de Desenvolimento Sustentável) da ONU, a ODS 7
            </Typography>
          </Box>
        </Grid>
        <Grid sm={6} alignItems="center" className="fgradient">
          <Box paddingX={20}>
            ...
            <Typography
              ...
              style={{ color: "white" }}
            >
              A ODS 7 põe em pauta o acesso às diferentes fontes de energia e a
              preservação ambiental. Nós comercializamos painéis solares e parte
              da renda é convertida à distribuição de energia em comunidades sem
              acesso.
            </Typography>
          </Box>
        </Grid>
